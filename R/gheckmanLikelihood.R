gheckmanLikelihood<-function(x, y, zh, yh, zo, ns, ndz, nSigma, coef, group, ngroup, nsMax, zo3Converter, noutcome, zo3, groupsize, nrhoY, ShowInfo=FALSE, maximization=FALSE)
{
  ...
  if(!is.null(Sigma[[1]]))
  {
    for (i in 1:noutcome)
    {
      SigmaPositively=SigmaPositively+is.positive.semi.definite(as.matrix(Sigma[[i]]));
    }
  }
...
gheckmanF=function(x, y, zh, yh, zo, ns, ndz, nSigma, coef, group, ngroup, nsMax, zo3Converter, noutcome, zo3, groupsize, nrhoY, ShowInfo=TRUE, maximization=FALSE)
{
...
gheckmanG=function(x, y, zh, yh, zo, ns, ndz, nSigma, coef, group, ngroup, nsMax, zo3Converter, noutcome, zo3, groupsize, nrhoY, ShowInfo=TRUE, maximization=FALSE)
{
